                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 hide_on_normal">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="customer_name" title="Select Customer" id="remove_regular_c_name" disabled>
                                    <option value="">Select</option>
                                    @foreach ($customers as $customer)
                                        <option @if($sold->customer_id == $customer->id) selected @endif value="{{$customer->id}}">{{$customer->customer_name}}</option>
                                    @endforeach
                                </select>
                                <input type="hidden" name="customer_id" value="{{$sold->customer_id}}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$sold->sold_date}}" class="form-control datepicker" name="sold_date" readonly>
                            </div>
                        </div>
                        {{-- <div class="col-md-6 show_on_normal">
                            <div class="form-group">
